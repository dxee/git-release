...
GIT_LOG_COMMITS="https://rdgit.travelsky.com/projects/DSS/repos/dss_v1_sdq_psgpreference/commits/"
GIT_LOG_PR="https://rdgit.travelsky.com/projects/DSS/repos/dss_v1_sdq_psgpreference/pull-requests/"
...
if [ -f "${SCRIPT_PATH}/config.sh" ]; then
    ...
    echo 'Missing file config.sh. Aborting'
    exit 1
fi

if [ -f "${SCRIPT_PATH}/../lib/.common-util.sh" ]; then
    source "${SCRIPT_PATH}/../lib/.common-util.sh"
else
    echo 'Missing file lib/.common-util.sh. Aborting'
    exit 1
fi
